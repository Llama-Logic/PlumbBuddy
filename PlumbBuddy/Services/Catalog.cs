...
public partial class Catalog :
    ICatalog
{
    public Catalog(ILogger<Catalog> logger, ISettings settings, IDbContextFactory<PbDbContext> pbDbContextFactory, IModsDirectoryCataloger modsDirectoryCataloger, IGameResourceCataloger gameResourceCataloger, IPublicCatalogs publicCatalogs)
    {
    ...
    bool isDisposed;
    bool isQuerying;
    readonly ILogger<Catalog> logger;
    ...
    async Task QueryManifestsAsync()
    {
        ...
        {
            logger.LogError(ex, "unhandled exception while querying");
        }
        finally
        {
            IsQuerying = false;
