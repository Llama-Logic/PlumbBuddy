(function () {
    ...
    window.mudpopoverHelper = {
        getCurrentUiZoom: function () {
            return +getComputedStyle(document.body).getPropertyValue('--plumbbuddy-zoom').trim();
        },
        ...
        calculatePopoverPosition: function (list, boundingRect, selfRect) {
            ...
            const currentUiZoom = this.getCurrentUiZoom();

            return {
                top: top / currentUiZoom, left: left / currentUiZoom, offsetX: offsetX / currentUiZoom, offsetY: offsetY / currentUiZoom, anchorY: top / currentUiZoom, anchorX: left / currentUiZoom
            };
        },
