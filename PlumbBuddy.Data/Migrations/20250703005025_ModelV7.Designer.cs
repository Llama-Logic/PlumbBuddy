...
namespace PlumbBuddy.Data.Migrations
{
    ...
    [Migration("20250703005025_ModelV7")]
    partial class ModelV7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlumbBuddy.Data.GameStringTableEntry", b =>
                {
                    ...
                    b.Property<long>("GameStringsPackageResourceId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("GameStringsPackageResourceId", "SignedKey")
                        .IsUnique();

                    b.ToTable("GameStringTableEntries");
                });

            modelBuilder.Entity("PlumbBuddy.Data.GameStringsPackage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("GameStringsPackages");
                });

            modelBuilder.Entity("PlumbBuddy.Data.GameStringsPackageResource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<long>("GameStringsPackageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<byte>("StringTableLocalePrefix")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.HasIndex("GameStringsPackageId", "KeyType", "KeyGroup", "KeyFullInstance")
                        .IsUnique();

                    b.ToTable("GameStringsPackageResources");
                });
            ...
            modelBuilder.Entity("PlumbBuddy.Data.GameStringTableEntry", b =>
                {
                    b.HasOne("PlumbBuddy.Data.GameStringsPackageResource", "GameStringsPackageResource")
                        .WithMany("StringTableEntries")
                        .HasForeignKey("GameStringsPackageResourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlumbBuddy.Data.GameStringsPackageResource", b =>
                {
                    b.HasOne("PlumbBuddy.Data.GameStringsPackage", "GameStringsPackage")
                        .WithMany("Resources")
                        .HasForeignKey("GameStringsPackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GameStringsPackage");
                });
