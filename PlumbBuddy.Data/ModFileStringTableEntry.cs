...
[Index(nameof(ModFileResourceId), nameof(SignedKey), IsUnique = true)]
public class ModFileStringTableEntry(ModFileResource modFileResource)
{
    ModFileStringTableEntry() :
        this(null!)
    {
    }
    ...
    public long ModFileResourceId { get; set; }

    [ForeignKey(nameof(ModFileResourceId))]
    public ModFileResource ModFileResource { get; set; } = modFileResource;
